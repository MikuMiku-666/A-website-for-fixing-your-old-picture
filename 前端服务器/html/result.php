...
<html lang="en">
  ...
  <?php
                            ...
                            "inference_gfpgan", "colorization", "vanceai"); 
                                if(count($images)>1) {
                                    $count = 0; 
                                    // echo "还在调试，别急"; 
                                } else {
            ...
            <header class="header-area">
                ...
                <main>
                    ...
                    <!-- breadcrumb area end -->
                     ...
                     <!-- team area start -->
                    <section id = "template" class="inner_team-area pt-20">
                        <?php    
                            echo ' <h5 class="choose-item-content-title" 
                                style="
                                    position: relative; 
                                    left: 20%; 
                                "
                        ...
                        <div class="container">
                            ...
                            <?php   
                                    ...
                                    $image_path = $folderPath.'/'.$image; 

                                    echo '<img src="'.$image_path.'" class="result_img" alt="'.$image.'"  
                                    style="
                                        max-width: 50%; 
                                        max-height: 50%; 
                                        margin-bottom: 5px;
                            ...
                            ?>
                                <form>
                                    <?php 
                                        echo '<div class="banner-content-btn-2">'; 
                                        if($number == 1){
                                            echo '<button id="downloadBtn'.$count.'" type="submit" class="theme-btn-3">'; 
                                            echo "下载图片"; 
                                            echo "</button>"; 
                                        }
                                        else echo "<p style='fond-size: 16px; '> 该算法运行失败</p>";  
                                    ?>

                                    <script>
                                        document.getElementById(<?php echo '"downloadBtn'.$count.'"'?>).addEventListener('click', function(e) {
                                            e.preventDefault(); // 阻止按钮的默认行为
                                
                                            // 图片的路径，这里应该是从服务器端获取的动态路径
                    ...
                    <section id = "template" class="inner_team-area pt-20">
                        ...
                        <div class="container">
                            ...
                            <?php   
                                    ...
                                    // 去掉文件扩展名
                                    $filename_without_ext = preg_replace('/\.[^\.]+$/', '', $filename);
                                    
                                    // 使用下划线分割字符串
                                    $parts = explode('_', $filename_without_ext);

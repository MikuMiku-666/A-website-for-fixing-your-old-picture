                        ...
                        <div class="col-12">
                            ...
                            <div class="swiper-container tour-grid-swiper">
                                <div class="swiper-wrapper">
                                    ...
                                    <?php 
                                         $command = "python3 ./program/main.py -id $userid 2>&1"; 
                                         if($mode == 1)
                                            $output = shell_exec($command); 
                                        else $output = "0 1 2 3 4 5 6 7"; 
                                        ...
                                        for($i = 0; $i <= 7; $i++){ 
                                            ...
                                            <div class="image">
                                                <a href="http://10.26.63.81/shijian/details/detail.php?id='.$id[$i].'&login='.$username.'">
                                                    <img src="'.$img_url[$i].'"
...
<div class="offcanvas offcanvas-bottom offcanvas-register" id="canvasRegister">
    <div class="wg-register wg-popup fw-6">
        ...
        <script>
               ...
               <!-- Login -->
        <div class="offcanvas offcanvas-bottom offcanvas-login" id="canvasChoose">
            <div class="wg-login wg-popup fw-6">
                <button class="btn-close-login" type="button" data-bs-dismiss="offcanvas" aria-label="Close">
                    <i class="icon-close1"></i>
                </button>
                <h4 class="title">
                    <span class="login">请选择你喜欢的标签</span>
                </h4>
                <form action="login.php" method="POST">
                <h1>请选择您喜欢的标签</h1>
                    <form id="tagForm">
                    ...
                    <div class="btn-login btn-popup">
                        <button type="submit" class="tf-btn color-primary text-body-3">提交</button>
                    </div>
                </form>
                <div class="text text-body-3 fw-4">
                    Not registered yet? <a href="#canvasRegister" data-bs-toggle="offcanvas" class="fw-6">Sign Up</a>

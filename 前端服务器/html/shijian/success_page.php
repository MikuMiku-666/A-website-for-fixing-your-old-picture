...
<body class="popup-loader total-number-variant date-picker">
    ...
    <!-- <img src="2.jpg" alt="Default Avatar" class="user-avatar"> -->
                                        ...
                                        <div class="tour-grid hover-img">
                                            <div class="image">
                                                <a href="tours-details-2.html">
                                                    <img src="image/tour-grid/tour-grid-1.jpg"
                                                        data-src="image/tour-grid/tour-grid-1.jpg" alt=""
                                                        class="lazyload">
                                                </a>
                                            ...
                                            <div class="tour-grid-content">
                                                ...
                                                <div class="title text-body-2 fw-6">
                                                    <a href="tours-details-2.html">番剧名称1</a>
                                                </div>
                                                ...
                                                <div class="price text-body-3">
                                                    简介: <span class="text-body-2 fw-1" style="font-size: 16px; ">简介内容你好你好你好久啊东海哦我的hi偶我打哈w殴打哈w偶等哈w欧的好哇都哈</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
.user-avatar {
    width: 8vw; /* 使用视口宽度的8%作为头像宽度 */
    height: 8vw; /* 使用视口宽度的8%作为头像高度 */
